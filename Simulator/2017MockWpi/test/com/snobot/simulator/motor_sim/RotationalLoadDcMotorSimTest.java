...
//
// DcMotorModel motor =
// MakeTransmission.makeTransmission(PublishedMotorFactory.makeRS775(), 2, 77.0,
// .8);
// IMotorSimulator motorSim = new RotationalLoadDcMotorSim(motor, wrapper,
// armCenterOfMass, armMass, constantAssistTorque, overCenterAssistTorque);
...
// {
// wrapper.set(1);
// bw.write(i * dt + ", " + motor.getPosition() + ", " + motor.getVelocity() +
// ", " + motor.getCurrent() + ", " + "\n");
// }
//
// bw.close();
