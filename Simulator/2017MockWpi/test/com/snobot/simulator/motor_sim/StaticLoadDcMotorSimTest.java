...
// {
// private DcMotorModel getSingle775WithTransmission(int numMotors, double
// effiecency)
// {
// return MakeTransmission.makeTransmission(PublishedMotorFactory.makeRS775(),
// numMotors, 10.0, effiecency);
// }
//
// @Test
// public void testRS775_6VSmallLoad()
// {
// StaticLoadDcMotorSim rs775 = new
// StaticLoadDcMotorSim(getSingle775WithTransmission(1, 1.0), .01);
//
...
// {
// StaticLoadDcMotorSim rs775 = new
// StaticLoadDcMotorSim(getSingle775WithTransmission(1, 1.0), 1.0);
//
...
// {
// StaticLoadDcMotorSim rs775 = new
// StaticLoadDcMotorSim(getSingle775WithTransmission(2, 1.0), 1.0);
//
...
// {
// StaticLoadDcMotorSim rs775 = new
// StaticLoadDcMotorSim(getSingle775WithTransmission(2, .8), 1.0);
//
